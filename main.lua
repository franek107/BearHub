...
fovCircle.Size = UDim2.new(0, r2, 0, r2)
...
fovCircleAim.Size = UDim2.new(0, r2, 0, r2)
...
for , ch in ipairs(c:GetChildren()) do if ch.Name:find("BearHub_HL") then pcall(function() ch:Destroy() end) end end
end
...
ddS.ScrollBarThickness=3; ddS.ScrollBarImageColor3=PURPLE; ddS.CanvasSize=UDim2.new(0,0,0,to28)
...
btn.MouseEnter:Connect(function() btn.BackgroundColor3=Color3.fromRGB(math.min(bc.R255+20,255),math.min(bc.G255+20,255),math.min(bc.B*255+20,255)) end)
...
-- General settings z bindem menu
