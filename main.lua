...
local function splitString(str, sep)
    ...
    while true do
        ...
        table.insert(parts, string.sub(str, lastPos, startPos - 1))
        lastPos = endPos + 1
    end
    table.insert(parts, string.sub(str, lastPos))
    return parts
end
...
-- ============================================================
-- MISC (HEAL, COPY, NO CLIP, RAPID FIRE, SUPER PUNCH, ETC)
-- ============================================================
do
    task.spawn(function()
        while true do
...
-- ============================================================
-- EXPLOITS (TELEPORT WALK, CLICK TELEPORT, ANTI-AFK)
-- ============================================================
do
    RunService.RenderStepped:Connect(function()
...
-- ============================================================
-- GUI MAIN - UPROSZCZONE (BEZ ZAKŁADKI EXECUTOR)
-- ============================================================
...
do
    ...
    contentTitle.BackgroundTransparency = 1; contentTitle.Text = "BearHub"
...
do
    ...
    -- FREECAM HUD (z poprzedniego skryptu)
    ...
    ctNb.MouseButton1Click:Connect(function()
        playClick(); EXPLOITS.ClickTeleportKeyName="NONE"; EXPLOITS.ClickTeleportKeyCheck=nil
        ctKeyBtn.Text="NONE"; ctDdF.Visible=false
    end)
    for i,opt in ipairs(BIND_OPTIONS_CT) do
        ...
        ob.MouseButton1Click:Connect(function()
            playClick(); EXPLOITS.ClickTeleportKeyName=name; EXPLOITS.ClickTeleportKeyCheck=cfn
            ctKeyBtn.Text=name; ctDdF.Visible=false
        end)
    end
    local ctDdO=false
...
print("BearHub w pełni załadowany!")
