...
mkClickTeleportKeybind(ctPanel,4)
...
local function makeTabBtn(name, order)
    local btn=Instance.new("TextButton",tabsFrame); btn.Size=UDim2.new(1,0,0,36); btn.BackgroundTransparency=1
...
print("BearHub załadowany pomyślnie!")
